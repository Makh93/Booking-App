  ...
  return (
    <div>
      ...
      <div className="resort">
        ...
        <Fade style={{fontSize: '30px', 
      fontWeight: 'bold'}} delay={1e3} cascade damping={1e-1}>
        Make your life Better and Bright! You must trip with Us!</Fade>

        <NavLink to="/room">
          <button className="Main-room">
            Book a Room
          </button>
        </NavLink>
